...
//   //     if (checked) {
//   //       // If checked, add the name to the formData
//   //       setFormData([...formData, name]);
//   //     } else {
//   //       // If unchecked, remove the name from the formData
//   //       setFormData(formData.filter((e) => e !== name));
//   //     }
//   //   };
...
//   //     console.log('Form submission',firstName,lastName);
//   //   };
...
// //       (fieldName) => checkedFields[fieldName]
// //     );
// //     const filteredFormData = formData.map((student) => {
// //       const filteredStudent = {};
// //       selectedFields.forEach((fieldName) => {
...
// //             value="firstName"
// //             name="firstName"
// //             checked={checkedFields.firstName || false}
