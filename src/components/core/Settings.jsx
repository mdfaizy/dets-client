...
// import { updateAdditionalDetails,deleteAccount } from '../../services/apiFunction/profileApi';
        ...
        <div className='mx-auto w-11/12 max-w-[1000px] py-10'>
          ...
          <div className='profile-section'>
            <div className='flex items-center gap-x-4'>
              ...
              <div className='space-y-2'>
                ...
                <form onSubmit={handleUpload}>
                  <div className='flex flex-row gap-3'>
                    <label className="cursor-pointer upload-button" htmlFor="upload">Select
            ...
            <div>
              <div className='relative mt-4'>
                <label className="w-full">
                  <p className="mb-1 text-[0.875rem] leading-[1.375rem] text-richblack-5">Old Password <sup className="text-pink-200">*</sup></p>
                  <input
                    required
                    type={showPassword ? "text" : "password"}
                    name="oldPassword"
          ...
          <div className="delete-account-section">
            ...
            <div className="delete-account-content">
              ...
              <button type="button" onClick={onDeleteAccount} className="delete-account-button">I want to delete my account.</button>
            </div>
          </div>
        </div>
      </div>
