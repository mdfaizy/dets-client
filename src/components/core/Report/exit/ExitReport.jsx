        ...
        <div className="m-4 p-4 ">
          <Row as={Col} md="4">
            ...
            <input
              ...
              value="year_cgpa_1st"
              name="year_cgpa_1st"
              checked={checkeds.year_cgpa_1st || false}
              onChange={handleChange}
            />

            <label htmlFor="year_cgpa_2nd"> Second Year CGPA:</label>
            <input
              type="checkbox"
              value="year_cgpa_2nd"
              name="year_cgpa_2nd"
              checked={checkeds.year_cgpa_2nd || false}
              onChange={handleChange}
            />
          ...
          <tbody>
            {filteredData.map((student, index) => (
              <tr key={index}>
                ...
                <td>{student.year_cgpa_1st}</td>
                <td>{student.year_cgpa_2nd}</td>
