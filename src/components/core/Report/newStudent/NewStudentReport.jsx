      ...
      <form onSubmit={handleSubmit}>
        <div className={style.filter_data_box}>
          <Row as={Col} md="4">
            ...
            <label htmlFor="parent_occupation">Parent Occoupation:</label>
            <input
              type="checkbox"
              value="parent_occupation"
              name="parent_occupation"
              checked={checkeds.parent_occupation || false}
              onChange={handleChange}
            />
            <label htmlFor="parent_income">Parent Incom:</label>
            <input
              type="checkbox"
              value="parent_income"
              name="parent_income"
              checked={checkeds.parent_income || false}
              onChange={handleChange}
            />
            ...
            <label htmlFor="score_rank">Rank</label>
            <input
              type="checkbox"
              value="score_rank"
              name="score_rank"
              checked={checkeds.score_rank || false}
              onChange={handleChange}
            />
            ...
            <input
              ...
              value="course_name"
              name="course_name"
              checked={checkeds.course_name || false}
              onChange={handleChange}
            />
            ...
            <input
              ...
              value="district"
              name="district"
              checked={checkeds.district || false}
              onChange={handleChange}
            />
            ...
            <label htmlFor="registration_no_10th"> Hs Regisration No:</label>
            <input
              type="checkbox"
              value="registration_no_10th"
              name="registration_no_10th"
              checked={checkeds.registration_no_10th || false}
              onChange={handleChange}
            />
            ...
            <label htmlFor="percentage_10th">Persentage:</label>
            <input
              type="checkbox"
              value="percentage_10th"
              name="percentage_10th"
              checked={checkeds.percentage_10th || false}
              onChange={handleChange}
            />
            ...
            <label htmlFor="registration_no_12th"> Ss Regisration No:</label>
            <input
              type="checkbox"
              value="registration_no_12th"
              name="registration_no_12th"
              checked={checkeds.registration_no_12th || false}
              onChange={handleChange}
            />
            ...
            <label htmlFor="percentage_12th"> Ss Persentage:</label>
            <input
              type="checkbox"
              value="percentage_12th"
              name="percentage_12th"
              checked={checkeds.percentage_12th || false}
              onChange={handleChange}
            />
          </Row>
