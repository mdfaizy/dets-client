...
//     // Example JWT and secret key (in a real scenario, the secret key should be stored securely)
//     const token = response.data.token;  // Use this token
...
// //   instructorKey: responseData.user.instructorKey,
// // }));
//         // console.log(responseData.user._id);
//         // Cookies.set("user", responseData.user._id); use karege loading
//         props.sendDataToParent(token); // Call the callback function with the data
...
//         if (responseData.user && responseData.user.instructorKey === 'ukdets@#1234' && responseData.user.accountType === 'Instructor') {
//           // Perform actions for Instructor login
//           setTeacher(true);
//           console.log('Logged in as an Instructor',responseData.user.accountType);
//         }
//         const token = responseData.token;

//         // Check accountType and instructorKey here
        
//         if (import.meta.env.VITE_REACT_APP_ADMIN_TOKEN === token) {
//           setIsAdmin(true);
//         }
//         setIsLoggedIn(true);
//         // if (responseData.user.instructorKey === 'ukdets@#1234'&& responseData.user.accountType === 'Instructor') {
//         //   // Perform actions for Instructor login
//         //   console.log('Logged in as an Instructor');
//         //     setTeacher(true);
//         // }
//         navigate("/");
//         toast.success("Login successful", {
