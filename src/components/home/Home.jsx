      ...
      <Carousel data-bs-theme="dark" className="">
        <Carousel.Item>
          ...
          <Carousel.Caption>
            ...
            <h5 className={style.university_name}>Kalyani University gets AICTE approval for B.Tech and M.Tech courses.</h5>
          </Carousel.Caption>
        </Carousel.Item>
        <Carousel.Item>
          <img
          ...
          />
          <Carousel.Caption>
            <h4 className={style.university_name}>Department of Engineering and Technological Studies</h4>
            <h5 className={style.university_name}>Faculty of Engineering Technology Management.</h5>
          </Carousel.Caption>
        </Carousel.Item>
        <Carousel.Item>
          ...
          <h3 className={style.university_name}>University of Kalyani </h3>
            ...
            The University of Kalyani, established in 1960, is a Government of West Bengal administered.
            </h5>
          </Carousel.Caption>
        </Carousel.Item>
      </Carousel>
